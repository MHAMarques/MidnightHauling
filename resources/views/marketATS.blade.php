...
<head>
    ...
    <title>{{$company['name']}} - Mercado ATS TruckyApp</title>
...
<body class="antialiased">
    ...
    <main>
        <section>
            ...
            <x-mainMarket pageTitle="Valores do Mercado ATS" pageDetails="Lista de cargas do mercado TruckyApp" />
            <div class="mainPage_Container">
                
                @foreach ($marketATS as $market)
                @php
                    ...
                    $marketDiff = number_format($marketDiff, 1);
                    $longDiff = ($avgIncome/1000) - $marketAdvantage;
                    $longDiff = number_format($longDiff, 1);
