        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="flex flex-wrap justify-center gap-6 lg:gap-8">
                    ...
                    <a href="\search" class="z-10 w-half min-w-screen p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Procure sua VTC</h2>

                            <p class="mt-4 px-6 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Acompanhe as métricas, as oportunidades e o desempenho da equipe de motoristas que compõe sua <strong>Virtual Transport Company</strong>. Utilize o <strong>Company ID</strong> de sua VTC no <strong>TruckyApp</strong> para ter acesso aos benefícios da ferramenta.
                            </p>
                        </div>
                    </a>
                    ...
                    <div class="z-10 w-quarter min-w-screen p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div class="h-16 w-full bg-gray-420 flex items-center justify-center rounded-lg">
                                ...
                                <h2 class="ml-4 text-xl font-semibold text-gray-900 dark:text-white">Company Id</h2>
                            </div>

                            
                            <p class="mt-4 px-6 text-gray-500 dark:text-gray-400 text-sm text-justify leading-relaxed">
                                Insira abaixo o ID de sua empresa no TruckyApp para carregar automaticamente sempre que entrar.
                            </p>
